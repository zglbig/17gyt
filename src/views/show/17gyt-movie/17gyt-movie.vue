<template>
	<el-row :gutter="5">
		...
		<!--        跑马灯-->
		<el-col :xs="{span:24,offset:0}" :sm="{span:21,offset:2}" :md="{span:21,offset:2}" :lg="{span:20,offset:2}" :xl="{span:19,offset:2}">
			<div class="grid-content">
				<el-carousel :interval="4000" type="card" height="200px">
					<el-carousel-item v-for="item in 6" :key="item">
						<el-link :underline="false" href="https://www.baidu.com" target="_blank">
							<el-card :body-style="{ padding: '0px' }">
								<img src="https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1585399477324&di=90ad1e5319f475208d7830adecfbd153&imgtype=0&src=http%3A%2F%2Fa4.att.hudong.com%2F21%2F09%2F01200000026352136359091694357.jpg"
								 class="image">
		...
		<!--        首页展示栏-->
		<el-col :xs="{span:24,offset:0}" :sm="{span:16,offset:2}" :md="{span:16,offset:2}" :lg="{span:16,offset:2}" :xl="{span:16,offset:2}">
			<div class="grid-content bg-purple-light">
				<el-row :gutter="5">
					<el-col :xs="{span:12,offset:0}" :sm="{span:2,offset:2}" :md="{span:16,offset:2}" :lg="{span:16,offset:2}" :xl="{span:4,offset:0}"
					 v-for="(o, index) in 5" :key="o">
						<el-link :underline="false" href="https://www.baidu.com" target="_blank">
							<el-card :body-style="{ padding: '0px' }">
								<img src="https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1585399477324&di=90ad1e5319f475208d7830adecfbd153&imgtype=0&src=http%3A%2F%2Fa4.att.hudong.com%2F21%2F09%2F01200000026352136359091694357.jpg"
								 class="image">
				...
				<el-pagination background layout="prev, pager, next" @current-change="handleCurrentChange" :pager-count="5" :page-size="5" :total="10" >
				</el-pagination>
			</div>
		</el-col>
		<!--        首页展示表格-->
		<el-col :xs="{span:24,offset:0}" :sm="{span:5,offset:0}" :md="{span:5,offset:0}" :lg="{span:4,offset:0}" :xl="{span:3,offset:0}">
